...
class SubmissionsControllerTest < ActionController::TestCase
  ...
  test "should update submission" do
    patch :update, id: @submission, submission: { bio: @submission.bio, email: @submission.email, name: @submission.name, phone_number: @submission.phone_number, sample_program: @submission.sample_program }
    assert_redirected_to submission_path(assigns(:submission))
  end
